...
public class Verde extends Nave {
	...
	protected void iniciarCuerpo(int x, int y) {
		...
		this.cuerpo.addPixel(new Coordenada(x - 4, y - 2, Color.GREEN));
		...
		this.cuerpo.addPixel(new Coordenada(x - 7, y, Color.GREEN));
		this.cuerpo.addPixel(new Coordenada(x - 4, y, Color.WHITE));
		this.cuerpo.addPixel(new Coordenada(x - 3, y, Color.ORANGE));
		...
		this.cuerpo.addPixel(new Coordenada(x - 7, y + 1, Color.GREEN));
		this.cuerpo.addPixel(new Coordenada(x - 4, y + 1, Color.ORANGE));
		...
		this.cuerpo.addPixel(new Coordenada(x - 3, y + 5, Color.GREEN));
		this.cuerpo.addPixel(new Coordenada(x - 2, y + 5, Color.GREEN));
		this.cuerpo.addPixel(new Coordenada(x - 1, y + 5, Color.WHITE));
		this.cuerpo.addPixel(new Coordenada(x, y + 5, Color.WHITE));
		this.cuerpo.addPixel(new Coordenada(x + 1, y + 5, Color.WHITE));
		this.cuerpo.addPixel(new Coordenada(x + 2, y + 5, Color.GREEN));
		...
		this.cuerpo.addPixel(new Coordenada(x - 3, y + 6, Color.GREEN));
		this.cuerpo.addPixel(new Coordenada(x - 2, y + 6, Color.GREEN));
		this.cuerpo.addPixel(new Coordenada(x, y + 6, Color.WHITE));
		this.cuerpo.addPixel(new Coordenada(x + 2, y + 6, Color.GREEN));
		this.cuerpo.addPixel(new Coordenada(x + 3, y + 6, Color.GREEN));
		this.cuerpo.addPixel(new Coordenada(x + 6, y + 6, Color.WHITE));
